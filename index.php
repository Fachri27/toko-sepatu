  ...
  <body>
    ...
    <div id="pre-header">
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            <span>Hallo selamat datang <b><?= $_SESSION['username'] ?> </b> </span>
            <?php  
            	if ($_SESSION['role'] == 'user') {
            		echo '
            					<a href="logout.php"><button type="submit" id="form-submit" class="button">Keluar?</button></a>
            					';
            	}
            	else{
            		echo '
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="section-heading">
              <div class="line-dec"></div>
              <h1>Rekomendasi untuk <b><?= $_SESSION['username'] ?></b></h1>
            </div>
          </div>
          <?php  
          	include 'koneksi.php';
          ...
          ?>
          <div class="col-md-3">
              <a href="detail.php?nama=<?= $data['nama_seo'] ?>">
                <div class="featured-item">
                  <img src="admin/produk/gambar/<?= $data['foto'] ?>" alt="Item 1">
                  <h4><?= $data['nama'] ?></h4>
                  <h6>Rp, <?= $data['harga'] ?></h6>
                </div>
              </a>
