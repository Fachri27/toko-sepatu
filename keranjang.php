            ...
            <div class="card-body">
                <table class="table" style="color: black;">
                    ...
                    <?php  
                    	...
                    	if($_SESSION['chart'] == ""){
                    		echo "<script> 
			                        alert('Keranjang kosong, yuk belanja lagi!');
                    ...
                    <tbody>
                            <tr>
                                ...
                                <th scope="row">
                                    <a href="delete_keranjang.php?id=<?= $data['id'] ?>"><button type="submit" class="btn btn-danger" name="Hapus">Hapus</button></a>
                                </th>
                            </tr>
                    </tbody>
                    <?php $no++; ?>
                ...
                <div class="row">
                	<a href="index.php"><button type="submit" class="btn btn-default mb-4 ml-5">Lanjut belanja</button></a>
                	<a href="checkout.php"><button type="submit" class="btn btn-primary mb-4 ml-5">Checkout</button></a>
                </div>
